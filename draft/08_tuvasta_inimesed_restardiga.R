...
detect_person_from_road <- function(x){
  ...
  if (detect_used_memory() < 1500) {
    ...
    rstudioapi::restartSession("source('/home/rstudio/Dropbox/DataScience/R/ristmike_liikluskaamerad/07_tuvasta_inimesed.R', echo = TRUE)")
...
## rstudio serveri script, mis käivitub üks kord 24.08
## see on vajalik, et skript uuesti käivitada kui see millegipärast on feilinud
...
# 49 14 24 8 * Rscript ~/Dropbox/DataScience/R/ristmike_liikluskaamerad/07_tuvasta_inimesed.R
